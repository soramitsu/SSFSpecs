#
# Be sure to run `pod lib lint SSFHelpers.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Radmir Dzhurabaev/SSFHelpers'
  ...
  s.source_files = 'SSFHelpers/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SSFHelpers' => ['SSFHelpers/Assets/*.png']
  # }
